    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (registerButton != null) {
            registerButton.setOnClickListener(v -> {
                if (getView() != null) {
                    try{
                        if(mViewModel.match(password.getText().toString(),
                                confirmPassword.getText().toString())){
                            mViewModel.registerAccount((Activity) getView().getContext(),
        ...
        if (loginButton != null) {
            loginButton.setOnClickListener(view -> mViewModel.setSignInPressed(true));
        }
