...
public final class ItemBinding implements ViewBinding {
  ...
  private ItemBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageViewMain,
      @NonNull FloatingActionButton whatsAppBtn) {
  ...
  public static ItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.imageViewMain;
      ImageView imageViewMain = ViewBindings.findChildViewById(rootView, id);
      if (imageViewMain == null) {
        break missingId;
      }

      id = R.id.whatsAppBtn;
      FloatingActionButton whatsAppBtn = ViewBindings.findChildViewById(rootView, id);
      if (whatsAppBtn == null) {
        break missingId;
      }

      return new ItemBinding((LinearLayout) rootView, imageViewMain, whatsAppBtn);
    }
