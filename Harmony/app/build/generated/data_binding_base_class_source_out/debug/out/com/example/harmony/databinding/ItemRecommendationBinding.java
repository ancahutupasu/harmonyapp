...
public final class ItemRecommendationBinding implements ViewBinding {
  ...
  private ItemRecommendationBinding(@NonNull RelativeLayout rootView, @NonNull TextView description,
  ...
  public static ItemRecommendationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecommendationBinding((RelativeLayout) rootView, description, title);
    }
